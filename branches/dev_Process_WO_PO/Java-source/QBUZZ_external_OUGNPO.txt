...
--
-- Author      : Avdhesh Dwivedi
--
-- CHANGE HISTORY
--
-- 0001 04-11-2022 - SPC-292 Worked on Business logic of Generate PO screen.
-- 0002 02-02-2023 - SPC-310 Generate PO button name changed and user group added.
-- -------------------------------------------------------------------------------
 */
var headerData = null;
...
function handleStatusChange(formPanel, changeMode) {
    try {
        ...
        if (changeMode === "DELAYED") {
            ...
            if (userGroup === "VLOOT-MAN" || userGroup === "KOPIE-R5" || userGroup === "R5-MOB-ADMIN" || userGroup === "R5") {
