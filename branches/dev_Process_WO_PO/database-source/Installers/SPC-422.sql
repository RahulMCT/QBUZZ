...
-- CHANGE HISTORY
--
-- 0001 14-09-2023  - MCT - SPC422  - Creation
-- -------------------------------------------------------------------------------
...
EXEC QBZ_O7CUSTOM( 'SPC-422.sql', '14-09-2023', 'QBZ-EAM 12.0', 'SPC-422.sql');

COMMIT;

PROMPT ...END of SPC-422.log
