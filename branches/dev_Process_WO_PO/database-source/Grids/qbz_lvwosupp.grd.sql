...
-- CHANGE HISTORY
--
-- 0001 23-09-2022  - MCT - SPC254  - Creation
-- -------------------------------------------------------------------------------

PROMPT ...Begin of qbz_lvwosupp.grd.sql
PROMPT

PROMPT ...Creating Lookup LVWOSUPP
PROMPT
DECLARE
...
BEGIN
  ...
  DELETE FROM r5boilertexts WHERE bot_function = 'BSLOVS' AND bot_fld1 IN ('lvwosuppcomcode','lvwosuppcomdesc','lvwosupcomorg');
  ...
  AND   bot_number > 4000;
  --set ddfields
  SELECT MIN(ddf_fieldid) INTO nfieldid1  FROM r5ddfield WHERE UPPER(ddf_tablename) = 'R5COMPANIES' AND UPPER(ddf_sourcename) = 'COM_CODE';
  IF nfieldid1 IS NULL THEN
  r5o7.o7maxseq(nfieldid1,'DDF','1',chk );
  --create ddfield
  INSERT INTO r5ddfield (ddf_fieldid,ddf_sourcename,ddf_datatype,ddf_tablename) VALUES(nfieldid1 ,'com_code','VARCHAR','R5COMPANIES');
  END IF;
  SELECT MIN(ddf_fieldid) INTO nfieldid2  FROM r5ddfield WHERE UPPER(ddf_tablename) = 'R5COMPANIES' AND UPPER(ddf_sourcename) = 'COM_DESC';
  IF nfieldid2 IS NULL THEN
  r5o7.o7maxseq(nfieldid2,'DDF','1',chk );
  --create ddfield
  INSERT INTO r5ddfield (ddf_fieldid,ddf_sourcename,ddf_datatype,ddf_tablename) VALUES(nfieldid2 ,'com_desc','MIXVARCHAR','R5COMPANIES');
  END IF;
  SELECT MIN(ddf_fieldid) INTO nfieldid3  FROM r5ddfield WHERE UPPER(ddf_tablename) = 'R5COMPANIES' AND UPPER(ddf_sourcename) = 'COM_ORG';
  IF nfieldid3 IS NULL THEN
  r5o7.o7maxseq(nfieldid3,'DDF','1',chk );
  --create ddfield
  INSERT INTO r5ddfield (ddf_fieldid,ddf_sourcename,ddf_datatype,ddf_tablename) VALUES(nfieldid3 ,'com_org','VARCHAR','R5COMPANIES');
  END IF;
  --set query
  cQuery :=
'FROM r5companies 
WHERE com_udfchkbox02 = ''+''';
  ...
  VALUES('Lov for Suppliers',cgridid,cQuery,cfunction
         ,nfieldid1
  ...
  --Creating grid field
  INSERT INTO r5gridfield (gfd_fieldid, gfd_gridid, gfd_botfunction, gfd_botnumber, gfd_controltype, gfd_scriptevent, gfd_tagname, gfd_updatecount, gfd_tagparams, gfd_aggfunc, gfd_fieldtype, gfd_occurrence, gfd_dependent,  gfd_secentity, gfd_headerlocation, gfd_updated) VALUES(nfieldid1, cgridid,  'BSLOVS', nmaxbotnum+1, 'TEXT', NULL, 'lvwosuppcomcode', 0, NULL, NULL, 'n', 1, NULL,  NULL, 'n',  SYSDATE);
  INSERT INTO r5gridfield (gfd_fieldid, gfd_gridid, gfd_botfunction, gfd_botnumber, gfd_controltype, gfd_scriptevent, gfd_tagname, gfd_updatecount, gfd_tagparams, gfd_aggfunc, gfd_fieldtype, gfd_occurrence, gfd_dependent,  gfd_secentity, gfd_headerlocation, gfd_updated) VALUES(nfieldid2, cgridid,  'BSLOVS', nmaxbotnum+2, 'TEXT', NULL, 'lvwosuppcomdesc', 0, NULL, NULL, 'n', 1, NULL,  NULL, 'n',  SYSDATE);
  INSERT INTO r5gridfield (gfd_fieldid, gfd_gridid, gfd_botfunction, gfd_botnumber, gfd_controltype, gfd_scriptevent, gfd_tagname, gfd_updatecount, gfd_tagparams, gfd_aggfunc, gfd_fieldtype, gfd_occurrence, gfd_dependent,  gfd_secentity, gfd_headerlocation, gfd_updated) VALUES(nfieldid3, cgridid,  'BSLOVS', nmaxbotnum+3, 'TEXT', NULL, 'lvwosupcomorg'  , 0, NULL, NULL, 'n', 1, NULL,  NULL, 'n',  SYSDATE);
  ...
  --create query fields
  INSERT INTO r5queryfield(dqf_ddspyid, dqf_fieldid, dqf_columnwidth, dqf_columnorder, dqf_updatecount, dqf_viewtype,  dqf_updated) VALUES(cdataspyid, nfieldid1, '150'  , 1, 0, 'LOV',   SYSDATE);
  ...
  SELECT 'BSLOVS', nmaxbotnum+1, 50, 0, 0, lin_code, 'Vendor code', 'F', '1', 'lvwosuppcomcode', NULL, NULL, NULL, NULL, '25000', '-', '-', 0 , NULL
  ...
  INSERT INTO r5boilertexts(bot_function, bot_number, bot_length, bot_xpos, bot_ypos, bot_lang, bot_text, bot_dest, bot_page, bot_fld1, bot_fld2, bot_prtp, bot_lvcr, bot_adlen, bot_pool, bot_changed, bot_display, bot_updatecount, bot_cloned)
  SELECT 'BSLOVS', nmaxbotnum+2, 50, 0, 0, lin_code, 'Description', 'F', '1', 'lvwosuppcomdesc', NULL, NULL, NULL, NULL, '25000', '-', '-', 0,  NULL
  ...
  INSERT INTO r5boilertexts(bot_function, bot_number, bot_length, bot_xpos, bot_ypos, bot_lang, bot_text, bot_dest, bot_page, bot_fld1, bot_fld2, bot_prtp, bot_lvcr, bot_adlen, bot_pool, bot_changed, bot_display, bot_updatecount, bot_cloned)
  SELECT 'BSLOVS', nmaxbotnum+3, 50, 0, 0, lin_code, 'Organization', 'F', '1', 'lvwosupcomorg', NULL, NULL, NULL, NULL, '25000', '-', '-', 0,  NULL
...
PROMPT ...Created Lookup LVWOSUPP
PROMPT

PROMPT ...End of qbz_lvwosupp.grd.sql
PROMPT
